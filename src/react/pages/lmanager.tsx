...
class LManager extends React.Component<Props, State> {
  state = {
    show: true
  };
      ...
      <div className="genericPage employeeManager">
        ...
        <div className="genericOneLineHolder">
          <div
            ...
            Wunderlist - Wunderlist Test Team
          </div>
          ...
          <div
            ...
            <div
              ...
              <div>$100</div>
              <div style={{ bottom: "0px", width: "60px", fontSize: "9px", position: "absolute" }}>
                ($10 per User)
              </div>
            </div>
          </div>
          ...
          <div style={{ gridColumn: 5, gridRow: 3, marginLeft: "10px", cursor: "pointer" }}>
            <i className="fal fa-ellipsis-h-alt" onClick={() => this.props.moveTo("lmanager/22")} />
          </div>
        </div>
