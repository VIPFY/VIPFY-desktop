              ...
              {({ loading, error, data }) => {
                ...
                return (
                  <div
                    ...
                    {userdata.online ? (
                      <div
                        className="roundedNotification online"
                        style={{ gridRow: 6, gridColumn: 1 }}>
                        Online
                      </div>
                    ) : (
                      <div
                        className="roundedNotification offline"
                        style={{ gridRow: 6, gridColumn: 1 }}>
                        Offline
                      </div>
                    )}
                    {userdata.admin ? (
                      <div
                        className="roundedNotification status"
                    ...
                    <div
                      className="roundedNotification button"
