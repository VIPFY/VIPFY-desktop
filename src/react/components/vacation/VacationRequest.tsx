    ...
    <Collapsible title="Request Vacation">
      ...
      {showPopup && (
        <PopupBase
            ...
            {requests.map((request, key) => {
              ...
              return (
                <li key={key}>
                  ...
                  <span>
                    {moment
                      .duration(endDate.endOf("day").diff(startDate.startOf("day")))
                      .humanize()}
                  </span>
                </li>
              );
          ...
          <UniversalButton type="low" label="Cancel" onClick={() => setShow(false)} />
          <UniversalButton type="high" label="confirm" onClick={() => console.log("FIRE")} />
        </PopupBase>
      )}
    </Collapsible>
  );
