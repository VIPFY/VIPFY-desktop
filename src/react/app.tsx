      ...
      <div className="fullSize">
        <Switch>
          <Route exact path="/" render={
              (props) => (<Login login={this.logMeIn} register={this.registerMe} error={this.state.error} {...props} />)}/>
          <Route path="/area" render={(props) => (<Area logMeOut={this.logMeOut} {...props}
                firstname={this.state.firstname} lastname={this.state.lastname}
                profilepicture={this.state.profilepicture} admin={this.state.admin} employees={this.state.employees} setName={this.setName}/>) } />
          <Route component={Bug} />
        </Switch>
      </div>
    );
