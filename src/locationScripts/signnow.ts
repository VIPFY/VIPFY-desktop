...
function onLoad() {
  if (document.querySelector("input[name='login-form-password']")) {
    ...
    ipcRenderer.on("loginData", (e, key) => {
      ...
      document.querySelector("input[name='login-form-email']")!.value = username;

      document
        .querySelector("input[name='login-form-email']")
      ...
      document.querySelector("input[name='login-form-password']")!.value = password;

      document
        .querySelector("input[name='login-form-password']")
        .dispatchEvent(new Event("change", { bubbles: true, cancelable: true }));
