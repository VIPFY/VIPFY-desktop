...
function onLoad() {
  if (document.getElementById("l-txt-password")) {
    ...
    ipcRenderer.on("loginData", (e, key) => {
      ...
      document.getElementById("l-txt-email-address")!.value = username;

      document
        .getElementById("l-txt-email-address")
      ...
      document.getElementById("l-txt-password")!.value = password;

      document
        .getElementById("l-txt-password")
        .dispatchEvent(new Event("change", { bubbles: true, cancelable: true }));
      ...
      clickButton(document.getElementById("l-btn-submit"));
    });
    hideLoading();
  } else {
    hideLoading();
