...
function onLoad() {
  if (document.querySelector("input[name='ctl00$cph_newtheme_main$Password']")) {
    ...
    ipcRenderer.on("loginData", (e, key) => {
      ...
      document.querySelector("input[name='ctl00$cph_newtheme_main$UserName']").value = username;
      document
        .querySelector("input[name='ctl00$cph_newtheme_main$UserName']")
      ...
      document.querySelector("input[name='ctl00$cph_newtheme_main$Password']").value = password;
      document
        .querySelector("input[name='ctl00$cph_newtheme_main$Password']")
        .dispatchEvent(new Event("change", { bubbles: true, cancelable: true }));
...
function hideLoading() {
  if (document.getElementById("ctl00$cph_newtheme_main$Password")) {
