...
function onLoad() {
  if (document.getElementById("user_session_password")) {
    ...
    ipcRenderer.on("loginData", (e, key) => {
      ...
      document.getElementById("user_session_login")!.value = username;

      document
        .getElementById("user_session_login")
      ...
      document
        .getElementById("user_session_password")
        .dispatchEvent(new Event("change", { bubbles: true, cancelable: true }));
      ...
      clickButton(document.getElementById("sign_in"));
    });
  } else {
    hideLoading();
  }
