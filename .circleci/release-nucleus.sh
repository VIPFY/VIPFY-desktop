...
VERSION_NAME=$(curl -b cookies.txt http://release.vipfy.store:3030/rest/app/1/channel/$CHANNEL_ID/temporary_releases | jq -r '.[0].version')
...
echo "The version is called $VERSION_NAME"
# Set Rollout to 100%
